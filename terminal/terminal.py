...
from reproduce import Ui_DecFuzzer as reproduce_Ui
...
class RunWindow(QtWidgets.QWidget, run_Ui):
    ...
    def stopPy_run(self):
        ...
        child = subprocess.Popen(["pgrep", "-f", "python3 test.py"], stdout=subprocess.PIPE, shell=False)
