...
lbl_124:;
    if(((!(!(l_4 < 644327542))) || ((!(l_4 < l_5)) || ((l_4 > l_5) && (l_4 > 644327542)))) || (l_4 < l_5))
    {/*True Guard */
    ...
    { /* block id: 49 */
        ...
        {/*True Condition Block*/
            int32_t backup_l_35 = (~l_35);
            if(!((((l_35 < 0) && (l_35 <= -2)) && (l_35 <= -1)) || ((l_35 > -1) || (!(l_35 < 0)))))
            {/*True Guard */
                backup_l_35 = l_35;
            }
            
            if((g_44_l < l_35) && (g_44_l > -1995129276))
            {/*True Guard */
                l_35 = (!g_44_l);
            }
            
            if((g_44_l <= -1995129275) && (g_44_l <= -1995129273))
            {
        ...
        if(g_44_l < l_35)
        {/*True Guard */
            if((((g_44_l <= -1995129271) || (g_44_l < -1995129271)) && (!(g_44_l >= -1995129269))) || (g_44_l < l_35))
            {/*True Guard */
    ...
    if(g_90_l < 575433424)
    {/*True Condition Block*/
        uint32_t backup_g_90_l = ((g_58_l < (g_56_l != g_34_l)) <= (~(-(g_90_l == g_33_l))));
        int32_t backup_g_34_l = (((!g_34_l) != (g_10_l > g_90_l)) <= ((~g_58_l) >> (!g_33_l)));
        uint32_t backup_g_70_l = (g_121_l * ((g_37_l != (g_10_l >= (-(!g_90_l)))) == g_58_l));
        uint32_t backup_g_33_l = ((-(g_10_l % g_71_l)) * (g_37_l >= g_121_l));
        int16_t backup_g_56_l = ((!(g_121_l != (-g_90_l))) | (-(((!g_56_l) | g_44_l) ^ g_70_l)));
        backup_g_90_l = g_90_l;
        if((g_34_l < -807865743) || (g_34_l > -807865743))
        {/*False Condition Block*/
            packed_printf(g_71_l);
        }
        
        backup_g_34_l = g_34_l;
        backup_g_70_l = g_70_l;
        backup_g_33_l = g_33_l;
        backup_g_56_l = g_56_l;
        if(!((g_121_l > 969412973) && (g_121_l >= 969412978)))
        {/*False Condition Block*/
        }
        
        g_90_l = ((g_37_l - g_90_l) != g_121_l);
        if((!(g_34_l <= -807865747)) && ((g_56_l < g_58_l) && (g_58_l < 4294967291)))
        {/*True Guard */
            g_34_l = ((!g_10_l) | (g_56_l | ((~g_33_l) & g_58_l)));
        }
        
        g_70_l = (g_71_l == g_121_l);
        g_33_l = ((g_33_l < (!(!g_56_l))) + (-(g_44_l - g_71_l)));
        g_56_l = ((g_10_l + g_44_l) < (g_71_l % g_56_l));
        if(((((g_71_l <= 108453795) && (g_37_l < g_121_l)) || (!(g_37_l < 11))) || (!((g_10_l < g_71_l) && (g_37_l < g_10_l)))) || (g_10_l > g_71_l))
        {
            packed_printf(g_71_l);
            ++backup_g_70_l;
        }
        ...
        if(!((g_70_l > 0) || (g_70_l > 0)))
        {/*True Guard */
            g_70_l = backup_g_70_l;
        }
        
        g_33_l = backup_g_33_l;
        if((g_56_l > 1) && (g_56_l >= 1))
        {/*False Condition Block*/
        }
