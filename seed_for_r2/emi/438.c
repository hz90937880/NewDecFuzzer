...
uint32_t g_83_l = 0U;
 ...
 /* block id: 0 */
    ...
    { /* block id: 4 */
        if((g_7_l < 2) && ((l_21 >= 338458864) || (l_21 >= 338458865)))
        {/*False Condition Block*/
            packed_printf(l_21);
        }
        
        if((g_22_l > l_9) || (g_22_l < l_9))
        {/*True Condition Block*/
            int32_t backup_g_10_l = (((~l_21) > (~g_7_l)) >= (!((l_9 == g_10_l) | (~(-(~g_20_l))))));
            int32_t backup_l_21 = (g_20_l > ((-(~g_22_l)) > (g_10_l | (l_9 & l_19))));
    ...
    { /* block id: 9 */
        ...
        int32_t l_63 = 1;
        int32_t l_70 = 4;
        for (g_22_l = 0; (g_22_l >= 25); g_22_l += 4)
        { /* block id: 6 */
            uint16_t l_35 = 6U;
