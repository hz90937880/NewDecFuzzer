...
uint32_t g_83_l = 0U;
 ...
 /* block id: 0 */
    ...
    { /* block id: 9 */
        ...
        int32_t l_70 = 4;
        g_71_l--;
        g_64_l |= (((-8) && ((((int8_t)(l_8 = (((int8_t)((int32_t)(l_63 |= (-4)) - (int32_t)l_82) % (int8_t)((int16_t)(-(int32_t)((int32_t)(!(((uint32_t)((l_35 = ((int16_t)(((g_54_l ^ g_20_l) != 247U) , g_52_l) << (int16_t)l_77)) > l_34) + (uint32_t)(-6)) == g_52_l)) - (int32_t)l_21)) % (int16_t)(-9))) , g_10_l)) >> (int8_t)g_83_l) >= (-6)) != g_52_l)) || l_35);
