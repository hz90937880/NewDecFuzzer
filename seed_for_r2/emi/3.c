...
uint32_t g_83_l = 0U;
 ...
 /* block id: 0 */
    ...
    {/*False Condition Block*/
        for (g_10_l = 0; (g_10_l <= 18); ++g_10_l)
        { /* block id: 54 */
            uint32_t l_125 = 0xF3A18F14;
        }
    }
    
    if((g_10_l > l_8) || (!(!((g_10_l > g_4_l) || (g_4_l < l_8)))))
    {/*True Condition Block*/
        int8_t backup_l_8 = ((~g_4_l) * ((l_9 | (l_8 <= g_10_l)) >= g_7_l));
        int32_t backup_l_9 = ((-g_4_l) < (((l_8 / (-g_10_l)) < l_9) - g_7_l));
        int32_t backup_g_10_l = (g_4_l != (!g_7_l));
        int8_t backup_g_4_l = (((~(-((-l_9) & g_7_l))) + (-(g_10_l < g_4_l))) == (~(!(-l_8))));
        backup_l_8 = l_8;
        backup_l_9 = l_9;
        backup_g_10_l = g_10_l;
        backup_g_4_l = g_4_l;
        l_8 = (-l_8);
        l_9 = ((g_4_l ^ (l_9 % (~g_7_l))) | (~g_10_l));
        g_10_l = (!g_4_l);
        g_4_l = (-g_7_l);
        if(g_7_l <= 0)
        {
