...
static int set_var(int16_t g_4_l, uint16_t g_15_l, uint32_t g_16_l){
    g_4 = g_4_l;g_15 = g_15_l;g_16 = g_16_l;
    return 0;
}
/* --- FUNCTIONS --- */
/* ------------------------------------------ */
...
static const uint32_t  func_1(void)
{
    ...
    set_var(0xffffb950, 0, 0x3817d1dc);
    return 0xec80f219;
}
