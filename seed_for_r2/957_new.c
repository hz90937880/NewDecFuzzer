 ...
 * Git version: unknown
 * Options:   --no-arrays --no-structs --no-unions --no-safe-math --no-pointers --no-longlong --max-funcs 1 --max-expr-complexity 5 --output ./tmp/src_code/csmith_test_742.c
 * Seed:      4121199611
 */
...
static uint16_t  func_1(void)
{
    ...
    for (var_4h = 0x12; -0x15 < var_4h; var_4h = var_4h + -1) {
    }
    set_var(var_4h);
    return var_4h;
}
