...
/* ------------------------------------------ */
/* 
 * reads : g_8 g_13 g_14 g_22
 * writes: g_14 g_13 g_22
 */
static uint32_t  func_1(void)
{    unsigned int stack0xfffffff4, unique0x00000f40;
    ...
    for (stack0xfffffff4 = 0; stack0xfffffff4 != -0x1c; unique0x00000f40 = stack0xfffffff4 + -1) {
    }
    set_var(0, -0x68c81f2f, 0, 0x2891ba7f);
    return 0xfffffff6;
}
