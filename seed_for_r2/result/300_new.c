...
static uint32_t g_14 = 0x6D21CD43;
...
static int set_var(int16_t g_6_l, uint8_t g_10_l, uint32_t g_14_l, uint32_t g_16_l, int32_t g_23_l){
    g_6 = g_6_l;g_10 = g_10_l;g_14 = g_14_l;g_16 = g_16_l;g_23 = g_23_l;
    return 0;
}
/* --- FUNCTIONS --- */
/* ------------------------------------------ */
...
{    unsigned int stack0xffffffe8;
    ...
    var_10h = 0;
    *(int *)0x0 = 1;
    for (var_2h = 0; -3 < (int16_t)var_2h; var_2h = (int16_t)var_2h + -1) {
        var_8h = var_8h | 0xffffea96;
        stack0xffffffe8 = 0;
        var_10h = (uint32_t)var_8h >> 6 & 3;
    }
    set_var((int32_t)(int16_t)var_2h, 1, var_8h, 0, var_10h);
