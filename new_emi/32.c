...
lbl_124:;
    ...
    { /* block id: 49 */
        if((!(g_44_l > l_35)) && (!((l_35 > -1) || (l_35 >= 0))))
        {/*True Condition Block*/
            int32_t backup_g_44_l = (~l_35);
        ...
        if((((g_44_l < l_35) || (g_44_l > l_35)) && ((g_44_l < l_35) || (g_44_l < l_35))) || (!(!(g_44_l < l_35))))
        {/*True Condition Block*/
            int32_t backup_l_35 = ((!(-l_35)) & (~g_44_l));
            if(l_35 >= 0)
            ...
            backup_l_35 = l_35;
            l_35 = (-g_44_l);
            while((g_44_l <= -1995129275) || (g_44_l < -1995129271))
            {
            }
            l_35 = backup_l_35;
        }
    ...
    if(((l_35 >= -1) || (g_34_l > l_35)) && ((!(!(g_44_l < 0))) && (((g_34_l > l_35) || (l_29 > g_58_l)) || (!(l_35 >= 0)))))
    {/*True Condition Block*/
        int32_t backup_g_71_l = ((~((g_44_l * l_35) != g_34_l)) >> (!(l_29 / g_58_l)));
        int32_t backup_g_44_l = (g_44_l + l_35);
        if((g_71_l >= 108453800) || (g_71_l >= 108453802))
        {/*False Condition Block*/
        }
        
        backup_g_71_l = g_71_l;
        backup_g_44_l = g_44_l;
        if((((l_29 >= 98) && (g_71_l < g_58_l)) || ((g_71_l <= 108453796) && (g_71_l >= 108453797))) || (g_58_l >= 4294967292))
        {/*False Condition Block*/
        }
        
        if((((g_71_l < g_58_l) || (l_29 < g_71_l)) || (g_71_l <= 108453797)) && (l_29 < g_71_l))
        {/*True Guard */
            g_71_l = (g_58_l >= (!(-(-l_29))));
        }
        ...
        if((l_35 > -2) && (g_34_l <= -807865743))
        {/*True Guard */
            g_44_l = ((!(!(((!g_44_l) < (-l_29)) <= (!(g_34_l == l_35))))) & (~g_58_l));
        }
        
        while(!((!(!(g_34_l > l_35))) || (((g_58_l < 4294967294) && (g_34_l < -807865740)) && ((l_29 <= 96) || (l_29 > g_58_l)))))
        {
        }
        if(!(g_71_l >= 2))
        {/*True Guard */
    ...
    if(g_44_l <= -807865743)
    {/*True Condition Block*/
        int32_t backup_g_44_l = ((g_56_l & g_37_l) <= (~g_10_l));
        backup_g_44_l = g_44_l;
        if(!(g_44_l <= -807865743))
        {/*False Condition Block*/
        }
        
        if((((g_44_l < -807865738) && (g_37_l > g_121_l)) || ((g_33_l > 0) || (g_121_l <= 969412975))) || (!(g_58_l >= 4294967295)))
        {/*True Guard */
            g_44_l = (((~g_44_l) | g_121_l) != (-(g_33_l != ((-g_37_l) & g_58_l))));
        }
        
        while(g_56_l > g_70_l)
        {
        }
        if((!(!(!(g_44_l >= 2)))) && (g_44_l < 2))
        {/*True Guard */
            if(g_44_l > 0)
            {/*True Guard */
                g_44_l = backup_g_44_l;
