...
// Address range: 0x80496cb - 0x8049838
int32_t func_1(void) {
    // 0x80496cb
...
// Address range: 0x8049838 - 0x80499b6
int main(int argc, char ** argv) {
    ...
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v3 + 0x27d5), v3 + 587, v2);
    transparent_crc((int32_t)*(int16_t *)(v3 + 0x27d7), v3 + 592, v2);
    transparent_crc((int32_t)*(char *)(v3 + 0x27d9), v3 + 597, v2);
    transparent_crc(*(int32_t *)(v3 + 0x27dd), v3 + 602, v2);
    transparent_crc(*(int32_t *)(v3 + 0x27e1), v3 + 607, v2);
    transparent_crc((int32_t)*(char *)(v3 + 0x27e5), v3 + 612, v2);
    transparent_crc((int32_t)*(int16_t *)(v3 + 0x27e7), v3 + 617, v2);
    transparent_crc((int32_t)*(char *)(v3 + 0x27e9), v3 + 622, v2);
    platform_main_end(-1 - *(int32_t *)(v3 + 0x27d1), v2);
    return 0;
}

// Address range: 0x80499b6 - 0x80499ba
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x80499b6
    return result;
}
