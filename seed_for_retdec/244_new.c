...
static int set_var(int32_t g_2_l, int32_t g_12_l, uint16_t g_13_l){
    g_2 = g_2_l;g_12 = g_12_l;g_13 = g_13_l;
    return 0;
}
/* --- FUNCTIONS --- */
/* ------------------------------------------ */
...
static uint16_t  func_1(void)
{
    ...
    set_var(-0x6acd44ef, 0x10ef, 0xfff9);
    return 0x10ef;
}
